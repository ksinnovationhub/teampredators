...
4. Make sure your code lints. Run `./gradlew ktlint` to check and run `./gradlew ktlintformat` to fix any lint issues that might arise
...
## Report bugs using Github's [issues](https://github.com/ksinnovationhub/teampredators/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/ksinnovationhub/teampredators/issues/new); it's that easy!
